  ...
  <app-frame>
    <v-container>
      ...
      <form @submit.prevent="submit">
        ...
        <v-text-field v-model="phone" :counter="10" :error-messages="errors.phone" label="Celular"></v-text-field>
        ...
        <v-checkbox v-model="checkbox" :error-messages="errors.checkbox" label="Habilitado"
          value="enabled"></v-checkbox>
        <v-checkbox v-model="checkbox" :error-messages="errors.checkbox" label="Deshabilitado"
