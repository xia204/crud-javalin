<template id="crud-page"> 
    <app-frame>
        <v-data-table :headers="empleados.headers" :items="empleados.items"
                                ...
                                <v-container>
                                    <v-row>
                                        <v-col cols="12" md="4" sm="6">
                                            <v-text-field v-model="empleados.editedItem.name"
                                                label="Dessert name"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="4" sm="6">
                                            <v-text-field v-model="empleados.editedItem.calories"
                                                label="Calories"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="4" sm="6">
                                            <v-text-field v-model="empleados.editedItem.fat"
                                                label="Fat (g)"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="4" sm="6">
                                            <v-text-field v-model="empleados.editedItem.carbs"
                                                label="Carbs (g)"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" md="4" sm="6">
                                            <v-text-field v-model="empleados.editedItem.protein"
...
app.component("crud-page", {
    ...
    computed: {
        formTitle() {
            return this.empleados.editedIndex === -1 ? 'New Item' : 'Edit Item'
        },
    },
    ...
    methods: {
        ...
        save() {
            if (this.empleados.editedIndex > -1) {
                Object.assign(this.empleados.items[this.empleados.editedIndex], this.empleados.editedItem)
            } else {
                this.empleados.items.push(this.empleados.editedItem)
            }
            this.close()
        },
    },
